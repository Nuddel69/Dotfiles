...
function screenshot(specify_region)
	...
	local target="/home/matsb/Pictures/Screenshots/%Y-%m-%d-%T.png"
	-- This code is a mess and needs to be changed.
	awful.spawn.easy_async_with_shell(command.." "..target,
		function(out,err)
			if err == "" then
				awful.spawn.easy_async_with_shell("notify-send \"Screenshot captured\" -i ~/Pictures/Screenshots/$(ls /home/matsb/Pictures/Screenshots/ -t | head -1)")
			end
		end)
end
...
globalkeys = gears.table.join(
	...
	-- Application runner
	awful.key({ modkey }, "d", function () awful.util.spawn("rofi -show drun -theme themes/drun.rasi") end,
    ...
    awful.key({modkey, "Shift"}, "v", function()
            awful.spawn("/home/matsb/scripts/theme-swap-menu.sh -r")
        end, {description = "Run theme switcher", group = "launcher"}),

	-- Brightness
	awful.key({}, "XF86MonBrightnessUp", function()
			awful.spawn.easy_async_with_shell("/home/matsb/scripts/brightness.sh up 700",
				function()
	...
	awful.key({}, "XF86MonBrightnessDown", function()
			awful.spawn.easy_async_with_shell("/home/matsb/scripts/brightness.sh down 700",
				function()
					awesome.emit_signal("brightness_refresh")
				end)

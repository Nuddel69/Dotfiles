...
local battery = battery_widget { ac_prefix = "🔌 ", battery_prefix = "🔋 ", alert_threshold = 15 }
...
-- Creates the battery widget.
local batteryPercentage = read_file("/sys/class/power_supply/BAT0/capacity");
...
awful.screen.connect_for_each_screen(function(s)
	...
	old_width = args.width + old_width
	width = 50
	args.width = width
	
	args.x = sgeo.x + sgeo.width - width - old_width - gap * 6
